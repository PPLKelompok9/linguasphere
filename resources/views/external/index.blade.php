                ...
                <div class="grid grid-cols-2 gap-5">
                    @forelse($data as $transaction)
                        <a href="#" class="card">
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <p class="flex items-center gap-[6px]">
                                    ...
                                    <span class="text-sm text-obito-text-secondary">{{$transaction->course->description}}</span>
                                </p>
                            </div>
                        </div>
                        </a>
                        ...
                        <div class="flex flex-col">
                            ...
                            <a href="{{ route('external.course') }}" class="bg-teal-700 hover:bg-white border border-gray-300 hover:border-teal-700 rounded-xl font-bold text-xl text-white hover:text-teal-700 text-center py-2">Beli Kursus</a>
                        </div>
                    @endforelse
