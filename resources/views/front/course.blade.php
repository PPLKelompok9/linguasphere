...
@section('title', 'Courses - Linguasphere')
@section('content')
    <x-nav-guests/>
    ...
    <main class="flex flex-col gap-10 pb-10 mt-[30px]">
        <section id="roadmap" class="flex flex-col w-full max-w-[1280px] px-[75px] gap-4 mx-auto">
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <a href="{{ route('courses.detail', ['id' => $category['id']]) }}" class="card">
                    <div
                        ...
                        <div
                            ...
                            <img src="{{ Storage::url($category['images']) }}" class="w-full h-full object-cover"
                                alt="thumbnail">
