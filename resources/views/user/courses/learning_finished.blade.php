...
<div class="relative flex justify-center">
    ...
    <main class="relative mt-[178px] flex flex-col gap-[30px] p-[30px] w-[560px] rounded-[20px] border bg-white border-obito-grey">
        ...
        <div class="mx-auto flex w-[500px] flex-col gap-[10px] items-center">
            ...
            <p class="text-center text-obito-text-secondary leading-[28px]">Anda telah menyelesaikan materi kelas dengan baik <br>Keep Sprit For Learning</p>
        </div>
        <div id="card" class="flex items-center pt-[10px] pb-[10px] pl-[10px] pr-4 border border-obito-grey rounded-[20px] gap-4">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center gap-[6px]">
                    ...
                    <p class="text-sm leading-[21px] text-obito-text-secondary">{{ $course->level }}</p>
                </div>
            </div>
        </div>
        <div class="buttons grid grid-cols-2 gap-[12px]">
            ...
            <a href="{{ route('external.dashboard') }}" class="text-white rounded-full py-[10px] flex justify-center items-center bg-obito-green hover:drop-shadow-effect transition-all duration-300">
