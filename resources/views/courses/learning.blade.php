            ...
            <div class="px-[30px]">
                <div class="content border border-obito-grey rounded-[20px] bg-white p-[12px] flex items-center justify-between">
                    ...
                    <div class="buttons flex items-center gap-[12px]">
                        ...
                        @else
                        <a href="{{ route('courses.finished', $course->slug) }}" class="rounded-full border bg-obito-green text-white px-5 py-[10px] hover:drop-shadow-effect transition-all duration-300">
